...
const AtemPerfectFitForm: React.FC = () => {
  ...
  return (
    <section id="contact-section" className="max-w-7xl mx-auto md:px-4 py-6 pb-24 text-left px-12 pt-28" tabIndex={-1}>
      <div className="max-w-screen-2xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-4 gap-6">
          ...
          <div>
            ...
            <h3 className="font-bold text-left md:text-center ~text-2xl/4xl">Tell us about yourself and well get back to you shortly.</h3>
            <ContactForm />
          </div> </div>
