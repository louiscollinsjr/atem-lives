        ...
        <div className="space-y-4 lg:max-w-3xl bottom-2">
          {header ?? (
            <>
              ...
              {title && (
                <h2 className="text-2xl sm:text-7xl font-aeonik tracking-wide font-gist flex items-center justify-center gap-4">
                  {title}
                  <svg 
                    className={`w-12 h-12 sm:w-20 sm:h-20 transition-transform duration-300 ${
