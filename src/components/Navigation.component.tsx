...
const Navigation: React.FC = () => {
  ...
  const { spotlightText } = useSpotlight();
  ...
  return (
    <Fragment>
      <nav className={`md:h-auto transition-all duration-300 ${scrolled ? 'bg-white' : 'bg-transparent'} fixed top-0 left-0 z-50 w-full`}>
        <div className="max-w-screen-2xl mx-auto px-4 md:px-4  py-3 flex justify-between items-center">
          <div className="flex items-center">
            <NavLink to="/" end>
              <img
                className="w-28 sm:w-20 invert-0"
                src={navLogo}
                alt="Logo"
          ...
          <div className="hidden md:flex space-x-4">
            <NavLink className={`text-xs transition-colors duration-300 text-black`} to="/">
            ...
            <NavLink className={`text-xs transition-colors duration-300 text-black`} to="/satchel">
              Satchel AR
            </NavLink>
          </div>
          <button
            className={`md:hidden text-2xl transition-colors duration-300 text-black`}
        ...
        <div className="hidden md:flex justify-between max-w-screen-2xl mx-auto md:px-4 py-3 ">
          <div className={`text-xl font-semibold tracking-[0.011em] leading-5 transition-colors duration-300 text-black`}>
            {t(spotlightText)}
          </div>
          <div className="space-x-4">
            ...
            //   onClick={() => scrollToSection('contact-section')}
              className={`text-xs transition-colors duration-300 text-black`}
            >
              {t("Contact us")}
            </NavLink>
