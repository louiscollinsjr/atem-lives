    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pb-12">
      ...
      <div className="sm:pt-6">
                ...
                <h1 className="text-left pb-12 text-4xl sm:text-4xl md:text-6xl font-light font-roboto tracking-normal sm:w-[32rem]">
                  {t("We’ve received your submission!")}
                ...
                <p className="text-left text-gray-800 font-light sm:w-[32rem] text-base pt-2 sm:pt-4">
                 {t("We’re excited to begin this journey with you! Our team will review your request, and since we have limited spots each month, we’ll confirm your project and timeline soon.")}<br/><br/> 
                 {t("We’re here to help bring your vision to life, and can’t wait to get started together. Stay tuned for more details - we will contact you shortly.")}
                </p>
              </div>
        </div>
